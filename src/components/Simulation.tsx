...
export const defaultSimulationParams: SimulationParams = {
    ...
    plantParams: {
        ...
        oldAge: new RandomizedStat(14, 6),
        radius: 5,
        color: "#1a9e00"
    },
    species: [
        {
            ...
            inheritedStats: {
                ...
                maxStamina: new RandomizedStat(60, 15),
                maxSatiety: new RandomizedStat(110, 25),
                oldAge: new RandomizedStat(180, 30),
        ...
        },
        {
            ...
            startingCount: 25,
            inheritedStats: {
                maxSpeed: new RandomizedStat(80, 9),
                visionRadius: new RandomizedStat(110, 18),
                maxStamina: new RandomizedStat(80, 18),
                maxSatiety: new RandomizedStat(100, 20),
                oldAge: new RandomizedStat(240, 40),
