...
export const defaultSimulationParams: SimulationParams = {
    ...
    plantParams: {
        startingCount: 40,
        spawnRate: 13,
        satietyValue: new RandomizedStat(50, 5),
        oldAge: new RandomizedStat(14, 2),
        radius: 5,
        color: "#1a9e00"
    },
    species: [
        {
            ...
            inheritedStats: {
                ...
                visionRadius: new RandomizedStat(100, 5),
                maxStamina: new RandomizedStat(60, 5),
                maxSatiety: new RandomizedStat(110, 10),
                oldAge: new RandomizedStat(180, 15),
                satietyValue: new RandomizedStat(60, 5),
            },
            satietyLoss: 2,
        ...
        },
        {
            ...
            startingCount: 25,
            inheritedStats: {
                maxSpeed: new RandomizedStat(80, 3),
                visionRadius: new RandomizedStat(110, 6),
                maxStamina: new RandomizedStat(80, 6),
                maxSatiety: new RandomizedStat(100, 10),
                oldAge: new RandomizedStat(250, 20),
                satietyValue: new RandomizedStat(80, 10),
            },
            satietyLoss: 2.5,
